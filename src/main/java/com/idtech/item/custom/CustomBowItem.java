...
public class CustomBowItem extends BowItem {
    ...
    public CustomBowItem(Properties pProperties, int range, float inaccuracy, int damage) {
        super(pProperties);
        this.range = range;
            ...
            if (!itemstack.isEmpty() || flag) {
                ...
                if (!((double)f < 0.1D)) {
                    ...
                    if (!pLevel.isClientSide) {
                        ...
                        abstractarrow.shootFromRotation(player, player.getXRot(), player.getYRot(), 0.0F, f * 3.0F, this.inaccuracy);
                        if (f == 1.0F) {
                        ...
                        if (j > 0) {
                            abstractarrow.setBaseDamage(abstractarrow.getBaseDamage() + (double)j * 0.5D + 0.5D + this.damage);
                        }
